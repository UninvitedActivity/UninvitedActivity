...
# Observations
- Obvious in retrospect, but running a DHT scraper (bitmagnet) means your IP address in advertised all over the DHT and thus invites a veritable shitload of traffic, effectively tripling the size of the IP address blocklist with a couple of days. I'm not sure how to manage all the additional IP addresses caused by this, but know that if I'm going to run a DHT scraper again, it's going to tunnel through somewhere other than where I'm gathering malicious IP addresses.
